...
const addData = function() {
    const data = {};
    const req = function(id, group=-1) {
        return {
            id: id,
            group: group
        }
    }
    const addCourse = function(x, y, id, name, credits, description, ...reqs) {
        data[id] = {
            pos: [x,y],
            name: name,
            credits: credits,
